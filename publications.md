  ...
  <div class="row">
		<div class="col-md-12 paperbox">
			<div class="media">
 			 	...
 			 	<div class="media-body">
 			 	    <div class="spacer"></div>
    				<div class="smallhead media-heading"><a href="/publications/2017-dissectvirulence-mbe/" class="off">Taming the BEAST—A Community Teaching Material Resource for BEAST 2</a></div>
    				<p class="note">Bertels et al. 2017. Molecular Biology and Evolution.</p>
  				</div>
			</div>
    </div>
